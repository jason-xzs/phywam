...
va_robotwin_train_cfg.dataset_path = '/data/public_data/xzs_data/lingbotva-post-training-dataset'
# va_robotwin_train_cfg.empty_emb_path = os.path.join(va_robotwin_train_cfg.dataset_path, 'empty_emb.pt')
va_robotwin_train_cfg.empty_emb_path = "/data/worldmodel_xzs/data/empty_emb.pt"
va_robotwin_train_cfg.enable_wandb = False
va_robotwin_train_cfg.load_worker = 16
va_robotwin_train_cfg.save_interval = 4000
va_robotwin_train_cfg.gc_interval = 50
va_robotwin_train_cfg.cfg_prob = 0.1
va_robotwin_train_cfg.phys_cfg_dropout = True
va_robotwin_train_cfg.phys_zero_init = True
va_robotwin_train_cfg.phys_gate = True
...
va_robotwin_train_cfg.gradient_accumulation_steps = 2
