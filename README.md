...
This repository is a code-only snapshot of the **PhyWAM 5-v3.6** experiment. It extends a frozen video-action WAM backbone with phase-aligned physical memory, late-block physics cross-attention, confidence-aware gating, and online phase-memory updates.
